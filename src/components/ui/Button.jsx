...
const Button = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative flex items-center justify-center px-4 py-2 sm:px-5 sm:py-2.5 md:px-8 md:py-2.5 lg:px-10 lg:py-3 transition-transform active:scale-95 ${className}`}
    >
      {/* Main Button Body */}
      <div
